 ...
 * @author PC
 */
public class SOAddFirma extends AbstractSO {
    ...
    protected void validate(AbstractDomainObject ado) throws Exception {
        ...
        for (Firma firma : firme) {
            if (firma.getPIB().equals(f.getPIB())) {
                throw new Exception("Vec postoji firma sa tim PIB-om!");
            }
            if (firma.getNazivFirme().equals(f.getNazivFirme())) {
                throw new Exception("Vec postoji firma sa tim nazivom!");
            }
